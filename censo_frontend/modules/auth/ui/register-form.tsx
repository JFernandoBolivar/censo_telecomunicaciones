...
import { Envelope, BuildingOffice, IdentificationBadge, Key, UserPlus, Spinner, Broadcast, ShieldCheck } from "@phosphor-icons/react";
...
export function RegisterForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-[440px]">
      ...
      <div className="glass-card w-full p-[40px]">
